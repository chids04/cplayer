...
:doit
if /i "%1#" == "--libs#"    echo -LE:/minGW_taglib/lib -llibtag
if /i "%1#" == "--cflags#"  echo -IE:/minGW_taglib/include -IE:/minGW_taglib/include/taglib
if /i "%1#" == "--version#" echo 2.0
if /i "%1#" == "--prefix#"  echo E:/minGW_taglib
