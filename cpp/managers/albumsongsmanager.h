#ifndef ALBUMSONGSMANAGER_H
#define ALBUMSONGSMANAGER_H
...
class AlbumSongsManager : public QObject
{
    Q_OBJECT
    QML_ANONYMOUS
...
public:
    explicit AlbumSongsManager(QObject *parent = nullptr);
    static AlbumSongsManager &instance();
